...
//        System.out.println("나는 CircleCal1의 areaCircle 이야");
//        super.areaCircle(20);
//        return Math.PI * radius * radius;
//    }
    //컴파일 단계에서 정확히 부모의 메소드를 오버라이딩 되었는지 체크하고 문제가 있으면 컴파일 에러를 출력한다.
    ...
    // 오버라이딩 (메소드의 재정의)은 부모 메소드는 숨겨지고, 자식 메소드만 사용되기 때문에 부모메소드의 길부만
    // 변경되더라도 중복된 내용을 자식 메소드도 가질 수 있다.
